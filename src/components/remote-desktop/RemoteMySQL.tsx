...
import { RemoteMySQLSidebar } from './RemoteMySQLSidebar';
    ...
    <>
      <div className="mysql-layout">
        <RemoteMySQLSidebar
          ...
          databases={databases}
          expandedDatabases={expandedDbs}
          filteredDatabases={filteredDatabases}
          history={history}
          loadingDatabases={loadingDbs}
          ...
          onRefreshDatabases={() => void refreshDatabases()}
          onSearchChange={setObjectSearch}
          onSelectTable={(database, table) => void handleSelectTable(database, table)}
