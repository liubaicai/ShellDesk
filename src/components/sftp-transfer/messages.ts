...
const zh = {
  ...
  expand: '展开', collapse: '收起', path: '路径', directoryTree: '目录树', resizeDirectoryTree: '调整目录树宽度',
  ...
  all: '全部', clearFinished: '清除已完成', concurrency: '并行任务', transferProfile: '传输模式', balancedProfile: '自适应', compatibilityProfile: '兼容', balancedProfileHint: '256 KiB 请求、单文件 16 路写入管线，并根据文件大小自动控制文件并发', compatibilityProfileHint: '32 KiB 请求、单任务单文件串行，适用于旧版或不稳定的 SFTP 服务端', afterComplete: '传输完成后', doNothing: '不做任何操作',
  ...
  uploadArrow: '上传选中项；未选择时上传当前目录内容', downloadArrow: '下载选中项；未选择时下载当前目录内容', pauseRestart: '暂停后继续会从已验证的临时文件断点续传',
...
const en: typeof zh = {
  ...
  expand: 'Expand', collapse: 'Collapse', path: 'path', directoryTree: 'directory tree', resizeDirectoryTree: 'Resize directory tree',
  ...
  all: 'All', clearFinished: 'Clear finished', concurrency: 'Concurrent tasks', transferProfile: 'Transfer mode', balancedProfile: 'Adaptive', compatibilityProfile: 'Compatibility', balancedProfileHint: '256 KiB requests, a 16-write per-file pipeline, and file concurrency adapted to workload size', compatibilityProfileHint: '32 KiB requests with one task and one file at a time for older or unstable SFTP servers', afterComplete: 'After transfer', doNothing: 'Do nothing',
  ...
  uploadArrow: 'Upload selected items; uploads the current folder contents when nothing is selected', downloadArrow: 'Download selected items; downloads the current folder contents when nothing is selected', pauseRestart: 'Resuming after pause continues from a verified staging checkpoint',
