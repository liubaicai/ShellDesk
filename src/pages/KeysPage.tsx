  ...
  return (
    <>
      <div className="command-bar no-drag key-command-bar">
        ...
        <button type="button" className="command-button" onClick={onImportPrivateKey}>导入密钥</button>
        <button type="button" className="primary-action" onClick={onCreateKey}>+ 新建密钥</button>
      </div>
