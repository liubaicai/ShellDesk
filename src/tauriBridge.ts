...
window.guiSSH = {
  ...
  connections: {
    ...
    rdpProbe: (connectionId, config) => ipc('connection:rdp-probe', connectionId, config),
    rdpStart: (connectionId, config) => ipc('connection:rdp-start', connectionId, config),
    rdpStop: (connectionId, rdpId) => ipc('connection:rdp-stop', connectionId, rdpId),
  ...
  events: {
    ...
    onRdpDiagnostic: (callback) => onTauriEvent('rdp:diagnostic', callback),
