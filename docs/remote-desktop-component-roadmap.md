...
| --- | --- | --- | --- | --- |
| 01 | `terminal` | 终端 | [终端组件重设计](./remote-desktop-components/01-terminal-redesign.md) | xterm.js 有界输出流、池化 russh PTY、隐藏渲染暂停、实时目录拆分、视口关键字高亮、安全链接、会话内命令补全、tmux 会话、命令请求与文件/记事本/AI 协作 |
