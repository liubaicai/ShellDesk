...
| --- | --- | --- | --- | --- |
| 01 | `terminal` | 终端 | [终端组件重设计](./remote-desktop-components/01-terminal-redesign.md) | xterm.js 会话、russh PTY 后端、终端工具菜单、退出策略、首个默认窗口优先使用且启用鼠标滚动的 tmux 会话、命令请求、文件/记事本/AI 协作 |
